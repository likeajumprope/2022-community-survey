...
(responses["is_member"].value_counts(normalize=True) * 100)


# Pie chart # geographic origin

labels = ['Europe','Oceania \n  (Australia & New Zealand)','North America, \n Canada &  Mexico)', 'South & \n Central America)' ,
          'Asia', 'Middle East']
percentages = [44.516129, 2.903226, 34.838710, 2.258065, 14.193548,   1.290323]
colors=['blue', 'yellow', 'green', 'orange','red', 'purple']

plt.pie(percentages,labels=labels, colors=colors, startangle=90, shadow=True,explode=(0.15, 0.15, 0.15, 0.15, 0.15, 0.15), autopct='%1.0f%%')

plt.title('Geographic Region', fontweight='bold', loc='left')
...
labels =['Doctoral student', 'Masters student','Established faculty member / \n group leader / \n principal investigator \n (i.e., 5 or more years \n from initial appointment)', 'Postdoctoral researcher', 'Non-academic position',                                                                                               
'Early-career faculty member / \n group leader / \n principal investigator \n (i.e., less than 5 years \n from initial appointment)', 'Research staff',                                                                                                           
  'Undergraduate student'] 
percentages = [26.774194,2.903226,26.451613, 17.741935,2.580645,12.258065, 9.354839,   1.935484]
colors=['blue', 'yellow', 'green', 'orange','red', 'purple', 'darkgrey','grey','indigo' ]

plt.pie(percentages,labels=labels, colors=colors, startangle=90, shadow=True,explode=(0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.15), autopct='%1.0f%%')

plt.title('Career stage', fontweight='bold', loc='left')
